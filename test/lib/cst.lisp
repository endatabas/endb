...
(defvar report-json
  "{\"kind\":\"Error\",\"msg\":\"parse error: unexpected SEL\",\"note\":\"/ sql_stmt_list / select_stmt / with_clause\",\"location\":[\"/sql\",0],\"labels\":[{\"span\":[\"/sql\",{\"start\":0,\"end\":3}],\"msg\":\"expected WITH\",\"color\":\"Red\",\"order\":0,\"priority\":0},{\"span\":[\"/sql\",{\"start\":0,\"end\":0}],\"msg\":\"while parsing with_clause\",\"color\":\"Blue\",\"order\":1,\"priority\":0}],\"source\":\"SEL\"}")

(test json-error-report
  (let ((report (fset:map ("kind" "Error")
                          ("msg" "parse error: unexpected SEL")
                          ("note" "/ sql_stmt_list / select_stmt / with_clause")
