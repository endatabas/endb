...
fn semi_structured() {
    ...
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|insert_stmt| ("INSERT" 0 6) ("INTO" 7 11) (:|table_name| (:|ident| ("users" 12 17))) (:|select_stmt| (:|select_core| (:|objects_clause| ("OBJECTS" 18 25) (:|object_expr| ("{" 26 27) (:|object_key_value_list| (:|object_key_value_pair| (:|object_key| (:|ident| ("foo" 27 30))) (":" 30 31) (:|numeric_literal| ("3" 32 33)))) ("}" 33 34)))))))"###);
}
