...
fn select_as() {
    assert_snapshot!(
        parse("SELECT 1 AS x, 2 y FROM z, w AS foo, LATERAL (SELECT bar) baz WHERE FALSE"),
        @r###"(:|sql_stmt_list| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_expr_list| (:|result_column| (:|numeric_literal| ("1" 7 8)) ("AS" 9 11) (:|column_alias| (:|ident| ("x" 12 13)))) ("," 13 14) (:|result_column| (:|numeric_literal| ("2" 15 16)) (:|column_alias| (:|ident| ("y" 17 18))))) (:|from_clause| ("FROM" 19 23) (:|join_clause| (:|table_or_subquery| (:|table_name| (:|ident| ("z" 24 25)))) (:|join_operator| ("," 25 26)) (:|table_or_subquery| (:|table_name| (:|ident| ("w" 27 28))) ("AS" 29 31) (:|table_alias| (:|ident| ("foo" 32 35)))) (:|join_operator| ("," 35 36)) (:|table_or_subquery| ("LATERAL" 37 44) (:|subquery| ("(" 45 46) (:|select_stmt| (:|select_core| ("SELECT" 46 52) (:|result_expr_list| (:|result_column| (:|column_reference| (:|column_name| (:|ident| ("bar" 53 56)))))))) (")" 56 57)) (:|table_alias| (:|ident| ("baz" 58 61)))))) (:|where_clause| ("WHERE" 62 67) (:|literal| ("FALSE" 68 73))))))"###);
    assert_snapshot!(
...
fn nested_access() {
    ...
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_expr_list| (:|result_column| (:|star| ("*" 7 8)))) (:|from_clause| ("FROM" 9 13) (:|join_clause| (:|table_or_subquery| (:|table_name| (:|ident| ("foo" 14 17)))) (:|join_operator| ("," 17 18)) (:|table_or_subquery| (:|table_function| (:|simple_function_invocation| (:|simple_func| (:|ident| ("UNNEST" 19 25))) ("(" 25 26) (:|expr_list| (:|column_reference| (:|table_name| (:|ident| ("foo" 26 29))) ("." 29 30) (:|column_name| (:|ident| ("bar" 30 33))))) (")" 33 34))) ("AS" 35 37) (:|table_alias| (:|ident| ("bar" 38 41)))))))))"###);
