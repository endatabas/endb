...
fn function_expr() {
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|function_call_expr| (:|function_name| ("foo" 7 10)) ("(" 10 11) (:|expr| (:|numeric_literal| ("2" 11 12))) ("," 12 13) (:|expr| (:|column_reference| (:|column_name| ("y" 14 15)))) (")" 15 16))))))))"###);
    assert_snapshot!(
        parse("SELECT count(y)"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|function_call_expr| (:|function_name| ("count" 7 12)) ("(" 12 13) (:|expr| (:|column_reference| (:|column_name| ("y" 13 14)))) (")" 14 15))))))))"###);
    assert_snapshot!(
        parse("SELECT TOTAL(y)"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|function_call_expr| (:|function_name| ("TOTAL" 7 12)) ("(" 12 13) (:|expr| (:|column_reference| (:|column_name| ("y" 13 14)))) (")" 14 15))))))))"###);
    assert_snapshot!(
        parse("SELECT count(*)"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|function_call_expr| (:|function_name| ("count" 7 12)) ("(" 12 13) ("*" 13 14) (")" 14 15))))))))"###);

    assert_snapshot!(
        parse("SELECT ARRAY_AGG(x ORDER BY y DESC)"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|function_call_expr| (:|function_name| ("ARRAY_AGG" 7 16)) ("(" 16 17) (:|expr| (:|column_reference| (:|column_name| ("x" 17 18)))) (:|order_by_clause| ("ORDER" 19 24) ("BY" 25 27) (:|ordering_term| (:|expr| (:|column_reference| (:|column_name| ("y" 28 29)))) ("DESC" 30 34))) (")" 34 35))))))))"###);

    assert_snapshot!(
        parse("SELECT count(*) FILTER (WHERE x > 2)"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|function_call_expr| (:|function_name| ("count" 7 12)) ("(" 12 13) ("*" 13 14) (")" 14 15) ("FILTER" 16 22) ("(" 23 24) ("WHERE" 24 29) (:|expr| (:|column_reference| (:|column_name| ("x" 30 31))) (">" 32 33) (:|numeric_literal| ("2" 34 35))) (")" 35 36))))))))"###);

    assert_snapshot!(
        parse("SELECT CAST ( - 69 AS INTEGER )"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|cast_expr| ("CAST" 7 11) ("(" 12 13) (:|expr| ("-" 14 15) (:|numeric_literal| ("69" 16 18))) ("AS" 19 21) (:|type_name| ("INTEGER" 22 29)) (")" 30 31))))))))"###);

    assert_snapshot!(
        parse("SELECT EXTRACT ( DAY FROM x )"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|extract_expr| ("EXTRACT" 7 14) ("(" 15 16) (:|datetime_field| ("DAY" 17 20)) ("FROM" 21 25) (:|expr| (:|column_reference| (:|column_name| ("x" 26 27)))) (")" 28 29))))))))"###)
}
...
fn simple_select() {
    assert_snapshot!(
        parse("SELECT 123"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|numeric_literal| ("123" 7 10))))))))"###);
    assert_snapshot!(
        parse("SELECT *"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|asterisk| ("*" 7 8)))))))"###);

    assert_snapshot!(
        parse("SELECT x.* FROM x"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|qualified_asterisk| (:|table_name| ("x" 7 8)) ("." 8 9) ("*" 9 10))) (:|from_clause| ("FROM" 11 15) (:|join_clause| (:|table_or_subquery| (:|table_name| ("x" 16 17)))))))))"###);
}

#[test]
fn select_as() {
    assert_snapshot!(
        parse("SELECT 1 AS x, 2 y FROM z, w AS foo, (SELECT bar) AS baz WHERE FALSE"),
    ...
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|numeric_literal| ("1" 7 8))) ("AS" 9 11) (:|column_alias| ("from" 12 16)))))))"###);
}
...
fn select() {
    ...
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|numeric_literal| ("1" 7 8)))) (:|from_clause| ("FROM" 9 13) (:|join_clause| (:|table_or_subquery| (:|table_name| ("x" 14 15))) (:|join_operator| ("CROSS" 16 21) ("JOIN" 22 26)) (:|table_or_subquery| (:|table_name| ("y" 27 28))) (:|join_constraint|)))))))"###);
    assert_snapshot!(
        parse("SELECT 1 FROM (x CROSS JOIN y)"),
    ...
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|numeric_literal| ("1" 7 8))))) (:|compound_operator| ("INTERSECT" 9 18)) (:|select_core| ("SELECT" 19 25) (:|result_column| (:|expr| (:|numeric_literal| ("2" 26 27))))) (:|compound_operator| ("UNION" 28 33)) (:|select_core| ("SELECT" 34 40) (:|result_column| (:|expr| (:|numeric_literal| ("3" 41 42))))))))"###);
    assert_snapshot!(
        parse("VALUES (1, 2), (3, 4)"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("VALUES" 0 6) ("(" 7 8) (:|expr| (:|numeric_literal| ("1" 8 9))) ("," 9 10) (:|expr| (:|numeric_literal| ("2" 11 12))) (")" 12 13) ("," 13 14) ("(" 15 16) (:|expr| (:|numeric_literal| ("3" 16 17))) ("," 17 18) (:|expr| (:|numeric_literal| ("4" 19 20))) (")" 20 21)))))"###);
    assert_snapshot!(
        parse("OBJECTS {a: 2}, {a: 4}"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("OBJECTS" 0 7) (:|object_expr| ("{" 8 9) (:|object_key_value_pair| ("a" 9 10) (":" 10 11) (:|expr| (:|numeric_literal| ("2" 12 13)))) ("}" 13 14)) ("," 14 15) (:|object_expr| ("{" 16 17) (:|object_key_value_pair| ("a" 17 18) (":" 18 19) (:|expr| (:|numeric_literal| ("4" 20 21)))) ("}" 21 22))))))"###);
...
fn group_by_having() {
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|numeric_literal| ("1" 7 8)))) (:|from_clause| ("FROM" 9 13) (:|join_clause| (:|table_or_subquery| (:|table_name| ("x" 14 15))))) (:|group_by_clause| ("GROUP" 16 21) ("BY" 22 24) (:|expr| (:|column_reference| (:|column_name| ("y" 25 26))))) (:|having_clause| ("HAVING" 27 33) (:|expr| ("TRUE" 34 38)))))))"###);
}
...
fn select_distinct() {
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) ("DISTINCT" 7 15) (:|result_column| (:|expr| (:|numeric_literal| ("1" 16 17)))) (:|from_clause| ("FROM" 18 22) (:|join_clause| (:|table_or_subquery| (:|table_name| ("x" 23 24)))))))))"###);
}
...
fn select_limit_offset() {
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|numeric_literal| ("1" 7 8)))) (:|from_clause| ("FROM" 9 13) (:|join_clause| (:|table_or_subquery| (:|table_name| ("x" 14 15)))))) (:|limit_offset_clause| ("LIMIT" 16 21) (:|expr| (:|numeric_literal| ("1" 22 23))) ("OFFSET" 24 30) (:|expr| (:|numeric_literal| ("2" 31 32)))))))"###);
    assert_snapshot!(
        parse("SELECT 1 FROM x LIMIT 1, 2"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|numeric_literal| ("1" 7 8)))) (:|from_clause| ("FROM" 9 13) (:|join_clause| (:|table_or_subquery| (:|table_name| ("x" 14 15)))))) (:|limit_offset_clause| ("LIMIT" 16 21) (:|expr| (:|numeric_literal| ("1" 22 23))) ("," 23 24) (:|expr| (:|numeric_literal| ("2" 25 26)))))))"###);
    assert_snapshot!(
        parse("SELECT 1 FROM x LIMIT 1"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|numeric_literal| ("1" 7 8)))) (:|from_clause| ("FROM" 9 13) (:|join_clause| (:|table_or_subquery| (:|table_name| ("x" 14 15)))))) (:|limit_offset_clause| ("LIMIT" 16 21) (:|expr| (:|numeric_literal| ("1" 22 23)))))))"###);
}
...
fn dml() {
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|insert_stmt| ("INSERT" 0 6) ("INTO" 7 11) (:|table_name| ("foo" 12 15)) ("(" 16 17) (:|column_name| ("x" 17 18)) (")" 18 19) (:|select_stmt| (:|select_core| ("VALUES" 20 26) ("(" 27 28) (:|expr| (:|numeric_literal| ("1" 28 29))) (")" 29 30) ("," 30 31) ("(" 32 33) (:|expr| (:|numeric_literal| ("2" 33 34))) (")" 34 35))))))"###);
    ...
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|update_stmt| ("UPDATE" 0 6) (:|table_name| ("foo" 7 10)) (:|update_body| ("SET" 11 14) (:|column_name| ("x" 15 16)) ("=" 17 18) (:|expr| (:|numeric_literal| ("1" 19 20))) ("," 20 21) (:|column_name| ("y" 22 23)) ("=" 24 25) (:|expr| (:|numeric_literal| ("2" 26 27))) ("WHERE" 28 33) (:|expr| ("NULL" 34 38))))))"###);

    assert_snapshot!(
        parse("UPDATE foo UNSET z, w WHERE FALSE"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|update_stmt| ("UPDATE" 0 6) (:|table_name| ("foo" 7 10)) (:|update_body| ("UNSET" 11 16) (:|column_name| ("z" 17 18)) ("," 18 19) (:|column_name| ("w" 20 21)) ("WHERE" 22 27) (:|expr| ("FALSE" 28 33))))))"###);
    assert_snapshot!(
        parse("UPDATE foo SET x = 1, y = 2 REMOVE z, w WHERE FALSE"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|update_stmt| ("UPDATE" 0 6) (:|table_name| ("foo" 7 10)) (:|update_body| ("SET" 11 14) (:|column_name| ("x" 15 16)) ("=" 17 18) (:|expr| (:|numeric_literal| ("1" 19 20))) ("," 20 21) (:|column_name| ("y" 22 23)) ("=" 24 25) (:|expr| (:|numeric_literal| ("2" 26 27))) ("REMOVE" 28 34) (:|column_name| ("z" 35 36)) ("," 36 37) (:|column_name| ("w" 38 39)) ("WHERE" 40 45) (:|expr| ("FALSE" 46 51))))))"###);
    assert_snapshot!(
        parse("UPDATE foo PATCH { z: 2 } WHERE FALSE"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|update_stmt| ("UPDATE" 0 6) (:|table_name| ("foo" 7 10)) (:|update_body| ("PATCH" 11 16) (:|object_expr| ("{" 17 18) (:|object_key_value_pair| ("z" 19 20) (":" 20 21) (:|expr| (:|numeric_literal| ("2" 22 23)))) ("}" 24 25)) ("WHERE" 26 31) (:|expr| ("FALSE" 32 37))))))"###);
    assert_snapshot!(
        parse("UPDATE foo SET $.a[0] = 1 WHERE FALSE"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|update_stmt| ("UPDATE" 0 6) (:|table_name| ("foo" 7 10)) (:|update_body| ("SET" 11 14) (:|path_expr| ("$" 15 16) ("." 16 17) ("a" 17 18) ("[" 18 19) (:|expr| (:|numeric_literal| ("0" 19 20))) ("]" 20 21)) ("=" 22 23) (:|expr| (:|numeric_literal| ("1" 24 25))) ("WHERE" 26 31) (:|expr| ("FALSE" 32 37))))))"###);
}
...
fn ddl() {
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|create_index_stmt| ("CREATE" 0 6) ("UNIQUE" 7 13) ("INDEX" 14 19) ("foo" 20 23) ("ON" 24 26) (:|table_name| ("t1" 27 29)) ("(" 29 30) (:|ordering_term| (:|expr| (:|column_reference| (:|column_name| ("a1" 30 32))))) ("," 32 33) (:|ordering_term| (:|expr| (:|column_reference| (:|column_name| ("b1" 33 35))))) (")" 35 36))))"###);
    assert_snapshot!(
        parse("DROP INDEX foo"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|ddl_drop_stmt| ("DROP" 0 4) ("INDEX" 5 10) ("foo" 11 14))))"###);
    assert_snapshot!(
        parse("CREATE TEMP VIEW foo AS SELECT 1"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|create_view_stmt| ("CREATE" 0 6) ("TEMP" 7 11) ("VIEW" 12 16) ("foo" 17 20) ("AS" 21 23) (:|select_stmt| (:|select_core| ("SELECT" 24 30) (:|result_column| (:|expr| (:|numeric_literal| ("1" 31 32)))))))))"###);
    assert_snapshot!(
        parse("CREATE TEMP VIEW foo(bar) AS SELECT 1"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|create_view_stmt| ("CREATE" 0 6) ("TEMP" 7 11) ("VIEW" 12 16) ("foo" 17 20) ("(" 20 21) (:|column_name| ("bar" 21 24)) (")" 24 25) ("AS" 26 28) (:|select_stmt| (:|select_core| ("SELECT" 29 35) (:|result_column| (:|expr| (:|numeric_literal| ("1" 36 37)))))))))"###);
    assert_snapshot!(
        parse("DROP VIEW IF EXISTS foo"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|ddl_drop_stmt| ("DROP" 0 4) ("VIEW" 5 9) ("IF" 10 12) ("EXISTS" 13 19) ("foo" 20 23))))"###);
    assert_snapshot!(
    ...
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|ddl_drop_stmt| ("DROP" 0 4) ("TABLE" 5 10) ("foo" 11 14))))"###);
    assert_snapshot!(
        parse("CREATE ASSERTION foo CHECK (1 == 1)"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|create_assertion_stmt| ("CREATE" 0 6) ("ASSERTION" 7 16) ("foo" 17 20) ("CHECK" 21 26) ("(" 27 28) (:|expr| (:|numeric_literal| ("1" 28 29)) ("==" 30 32) (:|numeric_literal| ("1" 33 34))) (")" 34 35))))"###);
    assert_snapshot!(
        parse("DROP ASSERTION foo"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|ddl_drop_stmt| ("DROP" 0 4) ("ASSERTION" 5 14) ("foo" 15 18))))"###);
}
...
fn multiple() {
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|numeric_literal| ("1" 7 8))))))) (";" 8 9) (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 10 16) (:|result_column| (:|expr| (:|numeric_literal| ("1" 17 18))))))) (";" 18 19))"###);
    assert_snapshot!(
        parse("SELECT 1; SELECT 1"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|numeric_literal| ("1" 7 8))))))) (";" 8 9) (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 10 16) (:|result_column| (:|expr| (:|numeric_literal| ("1" 17 18))))))))"###);
}
...
fn information_schema() {
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|asterisk| ("*" 7 8))) (:|from_clause| ("FROM" 9 13) (:|join_clause| (:|table_or_subquery| (:|table_name| ("information_schema" 14 32) ("." 32 33) ("tables" 33 39)))))))))"###);

    assert_snapshot!(
        parse("SELECT * FROM information_schema.columns AS c"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|asterisk| ("*" 7 8))) (:|from_clause| ("FROM" 9 13) (:|join_clause| (:|table_or_subquery| (:|table_name| ("information_schema" 14 32) ("." 32 33) ("columns" 33 40)) ("AS" 41 43) (:|table_alias| ("c" 44 45)))))))))"###);
}
...
fn system_time() {
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|asterisk| ("*" 7 8))) (:|from_clause| ("FROM" 9 13) (:|join_clause| (:|table_or_subquery| (:|table_name| ("Emp" 14 17)) ("FOR" 18 21) ("SYSTEM_TIME" 22 33) ("AS" 34 36) ("OF" 37 39) (:|bind_parameter| ("?" 40 41)))))))))"###);

    assert_snapshot!(
        parse("SELECT * FROM Emp FOR SYSTEM_TIME ALL"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|asterisk| ("*" 7 8))) (:|from_clause| ("FROM" 9 13) (:|join_clause| (:|table_or_subquery| (:|table_name| ("Emp" 14 17)) ("FOR" 18 21) ("SYSTEM_TIME" 22 33) ("ALL" 34 37))))))))"###);

    assert_snapshot!(
        parse("SELECT * FROM Emp FOR SYSTEM_TIME AS OF TIMESTAMP '2011-01-02 00:00:00'"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|asterisk| ("*" 7 8))) (:|from_clause| ("FROM" 9 13) (:|join_clause| (:|table_or_subquery| (:|table_name| ("Emp" 14 17)) ("FOR" 18 21) ("SYSTEM_TIME" 22 33) ("AS" 34 36) ("OF" 37 39) (:|timestamp_literal| ("TIMESTAMP" 40 49) ("'2011-01-02 00:00:00'" 50 71)))))))))"###);
    assert_snapshot!(
        parse("SELECT * FROM Emp FOR SYSTEM_TIME AS OF 2011-01-02 AS e"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|asterisk| ("*" 7 8))) (:|from_clause| ("FROM" 9 13) (:|join_clause| (:|table_or_subquery| (:|table_name| ("Emp" 14 17)) ("FOR" 18 21) ("SYSTEM_TIME" 22 33) ("AS" 34 36) ("OF" 37 39) (:|iso_date_literal| ("2011-01-02" 40 50)) ("AS" 51 53) (:|table_alias| ("e" 54 55)))))))))"###);
    assert_snapshot!(
...
fn temporal_scalars() {
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|iso_date_literal| ("2001-01-01" 7 17))))))))"###);
    assert_snapshot!(
        parse("SELECT DATE '2001-01-01'"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|date_literal| ("DATE" 7 11) ("'2001-01-01'" 12 24))))))))"###);
    assert_snapshot!(
        parse("SELECT DATE \"2001-01-01\""),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|date_literal| ("DATE" 7 11) ("\"2001-01-01\"" 12 24))))))))"###);
    ...
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|iso_time_literal| ("12:01:20" 7 15))))))))"###);
    assert_snapshot!(
        parse("SELECT TIME '12:01:20'"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|time_literal| ("TIME" 7 11) ("'12:01:20'" 12 22))))))))"###);

    assert_snapshot!(
        parse("SELECT 2023-05-16T14:43:39.970062Z"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|iso_timestamp_literal| ("2023-05-16T14:43:39.970062Z" 7 34))))))))"###);
    assert_snapshot!(
        parse("SELECT TIMESTAMP '2023-05-16 14:43:39'"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|timestamp_literal| ("TIMESTAMP" 7 16) ("'2023-05-16 14:43:39'" 17 38))))))))"###);
    assert_snapshot!(
        parse("SELECT P3Y6M4DT12H30M5S"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|iso_duration_literal| ("P3Y6M4DT12H30M5S" 7 23))))))))"###);
    assert_snapshot!(
        parse("SELECT P3Y6M"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|iso_duration_literal| ("P3Y6M" 7 12))))))))"###);
    assert_snapshot!(
        parse("SELECT PT12H30M5S"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|iso_duration_literal| ("PT12H30M5S" 7 17))))))))"###);

    assert_snapshot!(
        parse("SELECT CURRENT_DATE"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| ("CURRENT_DATE" 7 19)))))))"###);

    assert_snapshot!(
        parse("SELECT INTERVAL '1' HOUR"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|interval_literal| ("INTERVAL" 7 15) ("'1'" 16 19) (:|datetime_field| ("HOUR" 20 24)))))))))"###);
    assert_snapshot!(
        parse("SELECT INTERVAL '01:40' MINUTE TO SECOND"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|interval_literal| ("INTERVAL" 7 15) ("'01:40'" 16 23) (:|datetime_field| ("MINUTE" 24 30)) ("TO" 31 33) (:|datetime_field| ("SECOND" 34 40)))))))))"###);
    assert_snapshot!(
        parse("SELECT INTERVAL '2-3' YEAR TO MONTH"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|interval_literal| ("INTERVAL" 7 15) ("'2-3'" 16 21) (:|datetime_field| ("YEAR" 22 26)) ("TO" 27 29) (:|datetime_field| ("MONTH" 30 35)))))))))"###);
}
...
fn semi_structured() {
    assert_snapshot!(
        parse("SELECT []"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|array_expr| ("[" 7 8) ("]" 8 9))))))))"###);
    assert_snapshot!(
        parse("SELECT ARRAY []"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|array_expr| ("ARRAY" 7 12) ("[" 13 14) ("]" 14 15))))))))"###);
    assert_snapshot!(
        parse("SELECT [1, 2]"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|array_expr| ("[" 7 8) (:|expr| (:|numeric_literal| ("1" 8 9))) ("," 9 10) (:|expr| (:|numeric_literal| ("2" 11 12))) ("]" 12 13))))))))"###);

    assert_snapshot!(
        parse("SELECT ARRAY [1, 2,]"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|array_expr| ("ARRAY" 7 12) ("[" 13 14) (:|expr| (:|numeric_literal| ("1" 14 15))) ("," 15 16) (:|expr| (:|numeric_literal| ("2" 17 18))) ("," 18 19) ("]" 19 20))))))))"###);

    assert_snapshot!(
        parse("SELECT ARRAY (SELECT 1)"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|array_expr| ("ARRAY" 7 12) (:|subquery| ("(" 13 14) (:|select_stmt| (:|select_core| ("SELECT" 14 20) (:|result_column| (:|expr| (:|numeric_literal| ("1" 21 22)))))) (")" 22 23)))))))))"###);

    assert_snapshot!(
        parse("SELECT {}"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|object_expr| ("{" 7 8) ("}" 8 9))))))))"###);
    assert_snapshot!(
        parse("SELECT OBJECT()"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|object_expr| ("OBJECT" 7 13) ("(" 13 14) (")" 14 15))))))))"###);
    assert_snapshot!(
        parse("SELECT {foo: 2, bar: 'baz'}"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|object_expr| ("{" 7 8) (:|object_key_value_pair| ("foo" 8 11) (":" 11 12) (:|expr| (:|numeric_literal| ("2" 13 14)))) ("," 14 15) (:|object_key_value_pair| ("bar" 16 19) (":" 19 20) (:|expr| (:|string_literal| ("'baz'" 21 26)))) ("}" 26 27))))))))"###);
    assert_snapshot!(
        parse("SELECT {\"foo\": 2, 'bar': 'baz',}"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|object_expr| ("{" 7 8) (:|object_key_value_pair| (:|string_literal| ("\"foo\"" 8 13)) (":" 13 14) (:|expr| (:|numeric_literal| ("2" 15 16)))) ("," 16 17) (:|object_key_value_pair| (:|string_literal| ("'bar'" 18 23)) (":" 23 24) (:|expr| (:|string_literal| ("'baz'" 25 30)))) ("," 30 31) ("}" 31 32))))))))"###);
    assert_snapshot!(
        parse("SELECT {foo = 2, bar = 'baz'}"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|object_expr| ("{" 7 8) (:|object_key_value_pair| ("foo" 8 11) ("=" 12 13) (:|expr| (:|numeric_literal| ("2" 14 15)))) ("," 15 16) (:|object_key_value_pair| ("bar" 17 20) ("=" 21 22) (:|expr| (:|string_literal| ("'baz'" 23 28)))) ("}" 28 29))))))))"###);
    assert_snapshot!(
        parse("SELECT OBJECT(foo: 2, bar: 'baz')"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|object_expr| ("OBJECT" 7 13) ("(" 13 14) (:|object_key_value_pair| ("foo" 14 17) (":" 17 18) (:|expr| (:|numeric_literal| ("2" 19 20)))) ("," 20 21) (:|object_key_value_pair| ("bar" 22 25) (":" 25 26) (:|expr| (:|string_literal| ("'baz'" 27 32)))) (")" 32 33))))))))"###);
    ...
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|array_expr| ("[" 7 8) (:|expr| (:|numeric_literal| ("1" 9 10))) ("," 10 11) (:|expr| (:|numeric_literal| ("2" 12 13))) ("," 13 14) ("..." 15 18) (:|expr| (:|column_reference| (:|column_name| ("bar" 19 22)))) ("," 22 23) (:|expr| (:|numeric_literal| ("4" 24 25))) ("]" 26 27))))))))"###);
    ...
    assert_snapshot!(
        ...
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|insert_stmt| ("INSERT" 0 6) ("INTO" 7 11) (:|table_name| ("users" 12 17)) (:|select_stmt| (:|select_core| ("OBJECTS" 18 25) (:|object_expr| ("{" 26 27) (:|object_key_value_pair| ("foo" 27 30) (":" 30 31) (:|expr| (:|numeric_literal| ("3" 32 33)))) ("}" 33 34)))))))"###);
}
...
fn nested_access() {
    assert_snapshot!(
        parse("SELECT [][1]"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|array_expr| ("[" 7 8) ("]" 8 9)) ("[" 9 10) (:|expr| (:|numeric_literal| ("1" 10 11))) ("]" 11 12)))))))"###);
    assert_snapshot!(
        parse("SELECT {}.bar"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|object_expr| ("{" 7 8) ("}" 8 9)) ("." 9 10) ("bar" 10 13)))))))"###);

    assert_snapshot!(
        parse("SELECT {}.bar[x].baz"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|object_expr| ("{" 7 8) ("}" 8 9)) ("." 9 10) ("bar" 10 13) ("[" 13 14) (:|expr| (:|column_reference| (:|column_name| ("x" 14 15)))) ("]" 15 16) ("." 16 17) ("baz" 17 20)))))))"###);

    assert_snapshot!(
        parse("SELECT foo.bar.baz"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|column_reference| (:|table_name| ("foo" 7 10)) ("." 10 11) (:|column_name| ("bar" 11 14))) ("." 14 15) ("baz" 15 18)))))))"###);

    assert_snapshot!(
        parse("SELECT foo['bar'].baz"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|column_reference| (:|column_name| ("foo" 7 10))) ("[" 10 11) (:|expr| (:|string_literal| ("'bar'" 11 16))) ("]" 16 17) ("." 17 18) ("baz" 18 21)))))))"###);

    assert_snapshot!(
        parse("SELECT {}.bar[*].baz"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|object_expr| ("{" 7 8) ("}" 8 9)) ("." 9 10) ("bar" 10 13) ("[" 13 14) ("*" 14 15) ("]" 15 16) ("." 16 17) ("baz" 17 20)))))))"###);

    assert_snapshot!(
        parse("SELECT {}.bar..baz"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|object_expr| ("{" 7 8) ("}" 8 9)) ("." 9 10) ("bar" 10 13) (".." 13 15) ("baz" 15 18)))))))"###);

    assert_snapshot!(
        parse("SELECT $.bar.baz"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|path_expr| ("$" 7 8) ("." 8 9) ("bar" 9 12) ("." 12 13) ("baz" 13 16))))))))"###);

    assert_snapshot!(
        parse("SELECT $[#]"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|path_expr| ("$" 7 8) ("[" 8 9) ("#" 9 10) ("]" 10 11))))))))"###);
    assert_snapshot!(
        parse("SELECT $[# - 1]"),
        @r###"(:|sql_stmt_list| (:|sql_stmt| (:|select_stmt| (:|select_core| ("SELECT" 0 6) (:|result_column| (:|expr| (:|path_expr| ("$" 7 8) ("[" 8 9) ("#" 9 10) ("-" 11 12) (:|expr| (:|numeric_literal| ("1" 13 14))) ("]" 14 15))))))))"###);
